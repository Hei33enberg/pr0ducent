-- Second builder lane (Replit): full generic_rest adapter shape, disabled until real API + Edge secret.
-- Flip enabled=true only after: real api_base_url, REPLIT_ORCHESTRATOR_API_KEY in Edge, smoke per docs/SMOKE-TEST-ORCHESTRATOR.md.
