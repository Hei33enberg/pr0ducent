...
import { mergePreferredBuilderResult } from "@/lib/merge-builder-display";
        ...
        <AnimatePresence>
          {sortedRuns.map((run) => (
            <ToolTile
              ...
              builderResult={mergePreferredBuilderResult(
                builderResults[run.toolId],
                stream.results[run.toolId],
              )}
