...
export default function BuilderDashboard() {
  ...
  return (
    <PageFrame experiment={null} onBack={() => navigate("/")} onVisibilityChange={() => {}}>
      <div className="px-4 sm:px-8 lg:px-12 py-12 sm:py-16 max-w-6xl mx-auto">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <Badge
                      variant={builder.status === "active" ? "default" : "secondary"}
                      className="text-xs"
                    >
                      {builder.status}
                    </Badge>
                  ...
                  <div className="flex flex-wrap gap-1.5 mb-4">
                    {(builder.features as string[])?.slice(0, 4).map((feat, i) => (
                      <span
                        key={i}
                        className="text-xs bg-muted px-2 py-0.5 rounded-full text-muted-foreground font-sans"
                      >
                        {feat}
                      </span>
                    ))}
