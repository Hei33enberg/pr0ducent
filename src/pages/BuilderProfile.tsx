...
const BuilderProfileCharts = lazy(() => import("@/components/BuilderProfileCharts"));
          ...
          <Suspense
            fallback={
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                <Card className="min-h-[320px] animate-pulse bg-muted/20 border-border/50" />
                <Card className="min-h-[320px] animate-pulse bg-muted/20 border-border/50" />
              </div>
            }
          >
            <BuilderProfileCharts toolName={tool.name} radarData={radarData} distributionData={distributionData} />
          </Suspense>
